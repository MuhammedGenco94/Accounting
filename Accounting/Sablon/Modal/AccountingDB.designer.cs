...
namespace Accounting.Modal
{
    ...
    partial void InserttblStok(tblStok instance);
    partial void UpdatetblStok(tblStok instance);
    partial void DeletetblStok(tblStok instance);
    ...
    partial void DeletetblShipper(tblShipper instance);
		...
		public System.Data.Linq.Table<tblStok> tblStoks
		{
			get
			{
				return this.GetTable<tblStok>();
			}
		}
		...
		public System.Data.Linq.Table<vwSati> vwSatis
		{
			get
			{
				return this.GetTable<vwSati>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tblStok")]
	public partial class tblStok : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnUnitPriceChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tblProduct_tblStok", Storage="_tblProduct", ThisKey="ProductID", OtherKey="ID", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._tblProduct.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.tblStoks.Remove(this);
					}
					this._tblProduct.Entity = value;
					if ((value != null))
					{
						value.tblStoks.Add(this);
	...
	public partial class tblProduct : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<tblStok> _tblStoks;
    ...
    partial void OnUnitPriceChanged();
		...
		public tblProduct()
		{
			this._tblStoks = new EntitySet<tblStok>(new Action<tblStok>(this.attach_tblStoks), new Action<tblStok>(this.detach_tblStoks));
			this._tblPurchasings = new EntitySet<tblPurchasing>(new Action<tblPurchasing>(this.attach_tblPurchasings), new Action<tblPurchasing>(this.detach_tblPurchasings));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tblProduct_tblStok", Storage="_tblStoks", ThisKey="ID", OtherKey="ProductID")]
		public EntitySet<tblStok> tblStoks
		{
			get
			{
				return this._tblStoks;
			}
			set
			{
				this._tblStoks.Assign(value);
			}
		}
		...
		private void attach_tblStoks(tblStok entity)
		{
			this.SendPropertyChanging();
			entity.tblProduct = this;
		}
		
		private void detach_tblStoks(tblStok entity)
		{
			this.SendPropertyChanging();
    ...
    partial void OnEmployeeIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tblEmployee_tblPurchasing", Storage="_tblEmployee", ThisKey="EmployeeID", OtherKey="ID", IsForeignKey=true, DeleteRule="CASCADE")]
    ...
    partial void OnShipperIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tblEmployee_tblSalesUp", Storage="_tblEmployee", ThisKey="EmployeeID", OtherKey="ID", IsForeignKey=true, DeleteRule="CASCADE")]
		public tblEmployee tblEmployee
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tblShipper_tblSalesUp", Storage="_tblShipper", ThisKey="ShipperID", OtherKey="ID", IsForeignKey=true, DeleteRule="CASCADE")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.vwSatis")]
	public partial class vwSati
	{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CalisanAdi", DbType="NVarChar(100)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Unvani", DbType="NVarChar(100)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_KargoAdi", DbType="NVarChar(200)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FirmaAdi", DbType="NVarChar(100)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_BirimFiyati", DbType="Decimal(8,2)")]
