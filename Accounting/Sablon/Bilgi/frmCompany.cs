...
namespace Accounting.Bilgi
{
    public partial class frmCompany : Form
    {
        ...
        {
            if (edit && _firmaId>0 && _m.Guncelle()==DialogResult.Yes)
            {
                Guncelle();
            }
            else if (!edit)
        ...
        {
            if (edit && _firmaId > 0 && _m.Sil() == DialogResult.Yes)
            {
                Sil();
            }
        }
